...
namespace SecimPartisiProjesi
{
    public partial class FrmGrafikler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=LAPTOP-JNFOI6TN\SQLHASAN;Initial Catalog=DBSECIMPROJE;Integrated Security=True;Encrypt=False");
        

        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            // İlçe adlarını combobox a çevirme
